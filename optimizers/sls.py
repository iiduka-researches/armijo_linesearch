...
class SGD(torch.optim.Optimizer):
    ...
    def __init__(self,
        ...
        self.state['not_found']=0
        self.state['step_size_list']=[]
    ...
    def step(self,closure):
        ...
        for group in self.param_groups:
            ...
            step_size = ut.reset_step(batch_step_size,group['eta_max'],
                                    n_batches_per_epoch=group['n_batches_per_epoch'],
                                    gamma=group['gamma'],
                                    reset_option=group['reset_option'],
                                    init_step_size=group['init_step_size'],step_size_list=self.state['step_size_list'])
            ...
            self.state['step_size_list'].append(step_size)
            self.state['step'] += 1
