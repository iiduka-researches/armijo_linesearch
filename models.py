...
def get_models(dataset_name):
    ...
    if dataset_name=='CIFAR10':
        ...
        #return WideResNet(depth=28,widen_factor=10, num_classes=10)
...
class BasicBlockm(nn.Module):  # BasicBlock を BasicBlockm に変更
    ...
    def __init__(self, in_planes, planes, stride=1):
        super(BasicBlockm, self).__init__()  # super(BasicBlock, self) から BasicBlockm に変更
...
class ResNetm(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        # 最初の畳み込み層をMNIST用に調整
        self.conv1 = nn.Conv2d(1, 64, kernel_size=3, stride=1, padding=1, bias=False)  # 入力チャンネル数を1に変更
...
class WideResNet(nn.Module):
    def __init__(self, depth=28, num_classes=3, widen_factor=10, dropRate=0.0):
